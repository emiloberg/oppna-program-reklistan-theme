...
!function(e,t,n,o,r,a){function i(t,n){if(n){var o=n.getAttribute("viewBox"),r=e.createDocumentFragment(),a=n.cloneNode(!0);for(o&&t.setAttribute("viewBox",o);a.childNodes.length;)r.appendChild(a.childNodes[0]);t.appendChild(r)}}function l(){var t=this,n=e.createElement("x"),o=t.s;n.innerHTML=t.responseText,t.onload=function(){o.splice(0).map(function(e){i(e[0],n.querySelector("#"+e[1].replace(/(\W)/g,"\\$1")))})},t.onload()}function s(){for(var a;a=t[0];)if(r){var d=new Image;d.src=a.getAttribute("xlink:href").replace("#",".").replace(/^\./,"")+".png",a.parentNode.replaceChild(d,a)}else{var c=a.parentNode,u=a.getAttribute("xlink:href").split("#"),m=u[0],p=u[1];if(c.removeChild(a),m.length){var g=o[m]=o[m]||new XMLHttpRequest;g.s||(g.s=[],g.open("GET",m),g.onload=l,g.send()),g.s.push([c,p]),4===g.readyState&&g.onload()}else i(c,e.getElementById(p))}n(s)}(r||a)&&s()}(document,document.getElementsByTagName("use"),window.requestAnimationFrame||window.setTimeout,{},/MSIE\s[1-8]\b/.test(navigator.userAgent),/Trident\/[567]\b/.test(navigator.userAgent),document.createElement("svg"),document.createElement("use"));
...
!function(e,r){var t={isArray:Array.isArray||function(e){return"[object Array]"===Object.prototype.toString.call(e)},isPlainObj:function(e){return e===Object(e)},toArray:function(e){return Array.prototype.slice.call(e)},prepareArgs:function(e,r){return e=t.toArray(e),e.unshift(r),e},getObjKeyByValue:function(e,r){for(var t in e)if(e.hasOwnProperty(t)&&e[t]===r)return t},prepareReturn:function(r){return e[t.getObjKeyByValue(a,r)]},retrieve:function(e,t){return e==r?t:e},serialize:function(e){return JSON.stringify(e)},unserialize:function(e){return e==r?r:JSON.parse(e)}},n=function(){return n.get.apply(this,arguments)},i={storage:function(){return storage.get.apply(storage,arguments)},session:function(){return session.get.apply(session,arguments)}};n.set=function(e,r,n){if(t.isPlainObj(r))for(var i in r)r.hasOwnProperty(i)&&e.setItem(i,t.serialize(r[i]));else e.setItem(r,t.serialize(n));return t.prepareReturn(e)},n.invert=function(e,r){return this.set(e,r,!this.get(e,r))},n.add=function(e,r,t){return this.set(e,r,this.get(e,r)+parseInt(t,10))},n.increase=function(e,r,n){return this.add(e,r,t.retrieve(n,1))},n.decrease=function(e,r,n){return this.add(e,r,-t.retrieve(n,1))},n.concat=function(e,r,t){return this.set(e,r,this.get(e,r)+t)},n.push=function(e,r,n){var i=t.toArray(arguments),s=this.get(e,r,[]);return i.splice(0,2),s.push.apply(s,i),this.set(e,r,s)},n.extend=function(e,r,n,i){var s=this.get(e,r,{});if(t.isPlainObj(n))for(var a in n)n.hasOwnProperty(a)&&(s[a]=n[a]);else s[n]=i;return this.set(e,r,s)},n.remove=function(e,r){r=t.isArray(r)?r:t.toArray(arguments);for(var n=0,i=r.length;i>n;n++)delete e[r[n]];return t.prepareReturn(e)},n.empty=function(e){return e.clear(),t.prepareReturn(e)},n.get=function(e,n,i){if(i=i||r,t.isArray(n)){for(var s={},a=0,o=n.length;o>a;a++){var u=n[a];s[u]=this.get(e,u,i)}return s}return t.retrieve(t.unserialize(e.getItem(n)),i)},n.all=function(e){for(var r={},n=0,i=e.length;i>n;n++){var s=e.key(n);r[s]=t.unserialize(e.getItem(s))}return r};for(var s="set invert add increase decrease concat push extend remove empty get all".split(" "),a={storage:localStorage,session:sessionStorage},o=0,u=s.length;u>o;o++){var f=s[o];for(var c in a)if(a.hasOwnProperty(c)){var p=a[c];i[c][f]=function(e,r){return function(){var i=t.prepareArgs(arguments,r);return n[e].apply(n,i)}}(f,p)}}var g={storage:i.storage,session:i.session};"function"==typeof define&&define.amd?define(function(){return g}):"undefined"!=typeof exports?module.exports=g:(e.storage=i.storage,e.session=i.session)}(window);